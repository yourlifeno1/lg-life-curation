...
CITY_POINTS = [
# --- [1. 인구밀집지역] ---
    {"name": "가산디지털단지역", "lat": 37.4812, "lon": 126.8827, "category": "인구밀집지역", "code": "11545", "gu": "금천구"},
    ...
    {"name": "고덕역", "lat": 37.5550, "lon": 127.1541, "category": "인구밀집지역", "code": "11740", "gu": "강동구"},
    ...
    {"name": "구로역", "lat": 37.5030, "lon": 126.8820, "category": "인구밀집지역", "code": "11530", "gu": "구로구"},
    {"name": "군자역", "lat": 37.5572, "lon": 127.0795, "category": "인구밀집지역", "code": "11215", "gu": "광진구"},
    {"name": "대림역", "lat": 37.4932, "lon": 126.8949, "category": "인구밀집지역", "code": "11530", "gu": "구로구"},
    {"name": "동대문역", "lat": 37.5714, "lon": 127.0109, "category": "인구밀집지역", "code": "11110", "gu": "종로구"},
    {"name": "뚝섬역", "lat": 37.5472, "lon": 127.0474, "category": "인구밀집지역", "code": "11200", "gu": "성동구"},
    {"name": "발산역", "lat": 37.5585, "lon": 126.8377, "category": "인구밀집지역", "code": "11500", "gu": "강서구"},
    ...
    {"name": "삼각지역", "lat": 37.5345, "lon": 126.9728, "category": "인구밀집지역", "code": "11170", "gu": "용산구"},
    {"name": "서울대입구역", "lat": 37.4812, "lon": 126.9527, "category": "인구밀집지역", "code": "11620", "gu": "관악구"},
    {"name": "서울식물원·마곡나루역", "lat": 37.5667, "lon": 126.8273, "category": "인구밀집지역", "code": "11500", "gu": "강서구"},
    {"name": "서울역", "lat": 37.5546, "lon": 126.9706, "category": "인구밀집지역", "code": "11140", "gu": "중구"},
    {"name": "선릉역", "lat": 37.5045, "lon": 127.0490, "category": "인구밀집지역", "code": "11680", "gu": "강남구"},
    {"name": "성신여대입구역", "lat": 37.5927, "lon": 127.0165, "category": "인구밀집지역", "code": "11290", "gu": "성북구"},
    {"name": "수유역", "lat": 37.6380, "lon": 127.0257, "category": "인구밀집지역", "code": "11305", "gu": "강북구"},
    {"name": "숭례문", "lat": 37.5599, "lon": 126.9753, "category": "인구밀집지역", "code": "11140", "gu": "중구"},
    {"name": "시의회 앞", "lat": 37.5665, "lon": 126.9760, "category": "인구밀집지역", "code": "11140", "gu": "중구"},
    {"name": "신논현역·논현역", "lat": 37.5085, "lon": 127.0245, "category": "인구밀집지역", "code": "11680", "gu": "강남구"},
    ...
    {"name": "신정네거리역", "lat": 37.5201, "lon": 126.8529, "category": "인구밀집지역", "code": "11470", "gu": "양천구"},
    {"name": "신촌·이대역", "lat": 37.5567, "lon": 126.9413, "category": "인구밀집지역", "code": "11440", "gu": "마포구"},
    {"name": "쌍문역", "lat": 37.6486, "lon": 127.0347, "category": "인구밀집지역", "code": "11320", "gu": "도봉구"},
    {"name": "양재역", "lat": 37.484472, "lon": 127.03389, "category": "인구밀집지역", "code": "11650", "gu": "서초구"},
    {"name": "역삼역", "lat": 37.5006, "lon": 127.0365, "category": "인구밀집지역", "code": "11680", "gu": "강남구"},
    {"name": "연신내역", "lat": 37.6190, "lon": 126.9210, "category": "인구밀집지역", "code": "11470", "gu": "은평구"},
    {"name": "오목교역·목동운동장", "lat": 37.5244, "lon": 126.8752, "category": "인구밀집지역", "code": "11470", "gu": "양천구"},
    {"name": "왕십리역", "lat": 37.5612, "lon": 127.0371, "category": "인구밀집지역", "code": "11200", "gu": "성동구"},
    {"name": "용산역", "lat": 37.5298, "lon": 126.9648, "category": "인구밀집지역", "code": "11170", "gu": "용산구"},
    {"name": "이태원역", "lat": 37.5345, "lon": 126.9942, "category": "인구밀집지역", "code": "11170", "gu": "용산구"},
    {"name": "잠실새내역", "lat": 37.5116, "lon": 127.0861, "category": "인구밀집지역", "code": "11710", "gu": "송파구"},
    {"name": "잠실역", "lat": 37.5133, "lon": 127.1001, "category": "인구밀집지역", "code": "11710", "gu": "송파구"},
    {"name": "장지역", "lat": 37.4782, "lon": 127.1263, "category": "인구밀집지역", "code": "11710", "gu": "송파구"},
    {"name": "장한평역", "lat": 37.5619, "lon": 127.0646, "category": "인구밀집지역", "code": "11230", "gu": "동대문구"},
    {"name": "천호역", "lat": 37.5386, "lon": 127.1232, "category": "인구밀집지역", "code": "11740", "gu": "강동구"},
    {"name": "총신대입구(이수)역", "lat": 37.4862, "lon": 126.9819, "category": "인구밀집지역", "code": "11590", "gu": "동작구"},
    {"name": "충정로역", "lat": 37.5597, "lon": 126.9644, "category": "인구밀집지역", "code": "11410", "gu": "서대문구"},
    {"name": "합정역", "lat": 37.5495, "lon": 126.9145, "category": "인구밀집지역", "code": "11440", "gu": "마포구"},
    {"name": "혜화역", "lat": 37.5822, "lon": 127.0019, "category": "인구밀집지역", "code": "11110", "gu": "종로구"},
    {"name": "홍대입구역(2호선)", "lat": 37.5576, "lon": 126.9245, "category": "인구밀집지역", "code": "11440", "gu": "마포구"},
    {"name": "회기역", "lat": 37.5898, "lon": 127.0580, "category": "인구밀집지역", "code": "11230", "gu": "동대문구"},
    ...
    {"name": "광화문·덕수궁", "lat": 37.5701, "lon": 126.9773, "category": "고궁/문화유산", "code": "11110", "gu": "종로구"},
    {"name": "보신각", "lat": 37.5699, "lon": 126.9837, "category": "고궁/문화유산", "code": "11110", "gu": "종로구"},
    {"name": "서울 암사동 유적", "lat": 37.5601, "lon": 127.1309, "category": "고궁/문화유산", "code": "11740", "gu": "강동구"},
    {"name": "창덕궁·종묘", "lat": 37.5794, "lon": 126.9910, "category": "고궁/문화유산", "code": "11110", "gu": "종로구"},

    # --- [4. 공원] ---
    {"name": "강서한강공원", "lat": 37.5861, "lon": 126.8123, "category": "공원", "code": "11500", "gu": "강서구"},
    {"name": "고척돔", "lat": 37.4982, "lon": 126.8671, "category": "공원", "code": "11530", "gu": "구로구"},
    {"name": "광나루한강공원", "lat": 37.5488, "lon": 127.1232, "category": "공원", "code": "11740", "gu": "강동구"},
    {"name": "광화문광장", "lat": 37.5721, "lon": 126.9760, "category": "공원", "code": "11110", "gu": "종로구"},
    {"name": "국립중앙박물관·용산가족공원", "lat": 37.5238, "lon": 126.9804, "category": "공원", "code": "11170", "gu": "용산구"},
    {"name": "난지한강공원", "lat": 37.5661, "lon": 126.8783, "category": "공원", "code": "11440", "gu": "마포구"},
    {"name": "남산공원", "lat": 37.5509, "lon": 126.9889, "category": "공원", "code": "11170", "gu": "용산구"},
    {"name": "노들섬", "lat": 37.5175, "lon": 126.9581, "category": "공원", "code": "11170", "gu": "용산구"},
    {"name": "뚝섬한강공원", "lat": 37.5284, "lon": 127.0652, "category": "공원", "code": "11215", "gu": "광진구"},
    {"name": "망원한강공원", "lat": 37.5518, "lon": 126.8990, "category": "공원", "code": "11440", "gu": "마포구"},
    {"name": "반포한강공원", "lat": 37.5115, "lon": 126.9961, "category": "공원", "code": "11650", "gu": "서초구"},
    {"name": "북서울꿈의숲", "lat": 37.6206, "lon": 127.0423, "category": "공원", "code": "11305", "gu": "강북구"},
    {"name": "서리풀공원·몽마르뜨공원", "lat": 37.4912, "lon": 127.0054, "category": "공원", "code": "11650", "gu": "서초구"},
    {"name": "서울대공원", "lat": 37.4275, "lon": 127.0169, "category": "공원", "code": "41130", "gu": "과천시"},
    {"name": "서울숲공원", "lat": 37.5444, "lon": 127.0374, "category": "공원", "code": "11200", "gu": "성동구"},
    {"name": "아차산", "lat": 37.5513, "lon": 127.1021, "category": "공원", "code": "11215", "gu": "광진구"},
    {"name": "양화한강공원", "lat": 37.5383, "lon": 126.8974, "category": "공원", "code": "11560", "gu": "영등포구"},
    {"name": "어린이대공원", "lat": 37.5494, "lon": 127.0775, "category": "공원", "code": "11215", "gu": "광진구"},
    {"name": "여의도한강공원", "lat": 37.5284, "lon": 126.9331, "category": "공원", "code": "11560", "gu": "영등포구"},
    {"name": "월드컵공원", "lat": 37.5638, "lon": 126.8927, "category": "공원", "code": "11440", "gu": "마포구"},
    {"name": "응봉산", "lat": 37.5484, "lon": 127.0353, "category": "공원", "code": "11200", "gu": "성동구"},
    {"name": "이촌한강공원", "lat": 37.5173, "lon": 126.9723, "category": "공원", "code": "11170", "gu": "용산구"},
    {"name": "잠실종합운동장", "lat": 37.5148, "lon": 127.0736, "category": "공원", "code": "11710", "gu": "송파구"},
    {"name": "잠실한강공원", "lat": 37.5175, "lon": 127.0825, "category": "공원", "code": "11710", "gu": "송파구"},
    {"name": "잠원한강공원", "lat": 37.5212, "lon": 127.0118, "category": "공원", "code": "11650", "gu": "서초구"},
    {"name": "청계산", "lat": 37.4452, "lon": 127.0425, "category": "공원", "code": "11650", "gu": "서초구"},
    {"name": "보라매공원", "lat": 37.4918, "lon": 126.9197, "category": "공원", "code": "11590", "gu": "동작구"},
    {"name": "서대문독립공원", "lat": 37.5744, "lon": 126.9561, "category": "공원", "code": "11410", "gu": "서대문구"},
    {"name": "안양천", "lat": 37.5186, "lon": 126.8773, "category": "공원", "code": "11560", "gu": "영등포구"},
    {"name": "여의서로", "lat": 37.5303, "lon": 126.9191, "category": "공원", "code": "11560", "gu": "영등포구"},
    {"name": "올림픽공원", "lat": 37.5188, "lon": 127.1242, "category": "공원", "code": "11710", "gu": "송파구"},
    {"name": "홍제폭포", "lat": 37.5786, "lon": 126.9351, "category": "공원", "code": "11410", "gu": "서대문구"},
    {"name": "송현녹지광장", "lat": 37.5765, "lon": 126.9818, "category": "공원", "code": "11110", "gu": "종로구"},
    ...
    {"name": "광장(전통)시장", "lat": 37.5701, "lon": 126.9992, "category": "발달상권", "code": "11110", "gu": "종로구"},
...
def show_trend_section():
    CSV_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vS1Qox47HWyzFZT4mm3ZQsU8IYI2_PWtWb0Cg4_8YxaZsu7vBeUv7urCQO5z-Tcd5JhfZXkeG4bvqkw/pub?gid=0&single=true&output=csv"
    ...
    try:
        ...
        # 데이터 정렬 및 10개 추출
        w_df = df[df['구분'] == 'WEEKLY'].sort_values(by=['클릭지수', '품목명'], ascending=[False, True]).reset_index(drop=True).head(10)
        d_df = df[df['구분'] == 'DAILY'].sort_values(by=['클릭지수', '품목명'], ascending=[False, True]).reset_index(drop=True).head(10)
        
        w_p = w_df['집계기간'].iloc[0] if not w_df.empty else "-"
        d_p = d_df['집계기간'].iloc[0] if not d_df.empty else "-"

        # 1. 주간 리스트 HTML 미리 만들기
        w_items_html = ""
        for i, row in w_df.iterrows():
            rank = "1" if row['클릭지수'] == 100 else str(i+1)
            w_items_html += f'<div style="margin-bottom:8px;font-size:13px;display:flex;"><b style="color:#FF4B4B;width:22px;">{rank}</b><span style="color:#495057;">{row["품목명"]}</span></div>'

        # 2. 일간 리스트 HTML 미리 만들기
        d_items_html = ""
        for i, row in d_df.iterrows():
            rank = "1" if row['클릭지수'] == 100 else str(i+1)
            d_items_html += f'<div style="margin-bottom:8px;font-size:13px;display:flex;"><b style="color:#3182CE;width:22px;">{rank}</b><span style="color:#495057;">{row["품목명"]}</span></div>'

        # 3. 전체 레이아웃 합치기 (이 전체가 하나의 문자열입니다)
        # f-string의 중괄호 충돌을 피하기 위해 {{ }} 를 사용합니다.
        full_html = f"""
