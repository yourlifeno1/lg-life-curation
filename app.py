...
CITY_POINTS = [
# --- [1. 인구밀집지역] ---
    {"name": "강남역", "lat": 37.4979, "lon": 127.0276, "category": "인구밀집지역", "code": "11680"},
    {"name": "쌍문역", "lat": 37.6486, "lon": 127.0347, "category": "인구밀집지역", "code": "11320"},
    {"name": "수유역", "lat": 37.6380, "lon": 127.0257, "category": "인구밀집지역", "code": "11305"},
    {"name": "창동역", "lat": 37.6531, "lon": 127.0476, "category": "인구밀집지역", "code": "11320"},
    {"name": "노원역", "lat": 37.6548, "lon": 127.0605, "category": "인구밀집지역", "code": "11350"},
    {"name": "건대입구역", "lat": 37.5404, "lon": 127.0692, "category": "인구밀집지역", "code": "11215"},
    {"name": "고속터미널역", "lat": 37.5045, "lon": 127.0050, "category": "인구밀집지역", "code": "11650"},
    {"name": "교대역", "lat": 37.4934, "lon": 127.0142, "category": "인구밀집지역", "code": "11650"},
    {"name": "구로디지털단지역", "lat": 37.4852, "lon": 126.9015, "category": "인구밀집지역", "code": "11530"},
    {"name": "미아사거리역", "lat": 37.6133, "lon": 127.0300, "category": "인구밀집지역", "code": "11305"},
    {"name": "사당역", "lat": 37.4765, "lon": 126.9815, "category": "인구밀집지역", "code": "11590"},
    {"name": "서울역", "lat": 37.5546, "lon": 126.9706, "category": "인구밀집지역", "code": "11140"},
    {"name": "신도림역", "lat": 37.5089, "lon": 126.8912, "category": "인구밀집지역", "code": "11530"},
    {"name": "신림역", "lat": 37.4842, "lon": 126.9297, "category": "인구밀집지역", "code": "11620"},
    {"name": "연신내역", "lat": 37.6190, "lon": 126.9210, "category": "인구밀집지역", "code": "11470"},
    {"name": "용산역", "lat": 37.5298, "lon": 126.9648, "category": "인구밀집지역", "code": "11170"},
    {"name": "잠실역", "lat": 37.5133, "lon": 127.1001, "category": "인구밀집지역", "code": "11710"},
    {"name": "홍대입구역(2호선)", "lat": 37.5576, "lon": 126.9245, "category": "인구밀집지역", "code": "11440"},

    # --- [2. 관광특구] ---
    {"name": "강남 MICE 관광특구", "lat": 37.5126, "lon": 127.0589, "category": "관광특구", "code": "11680"},
    {"name": "동대문관광특구", "lat": 37.5685, "lon": 127.0060, "category": "관광특구", "code": "11140"},
    {"name": "명동관광특구", "lat": 37.5636, "lon": 126.9841, "category": "관광특구", "code": "11140"},
    {"name": "이태원관광특구", "lat": 37.5345, "lon": 126.9946, "category": "관광특구", "code": "11170"},
    {"name": "잠실관광특구", "lat": 37.5133, "lon": 127.1001, "category": "관광특구", "code": "11710"},
    {"name": "종로·청계관광특구", "lat": 37.5700, "lon": 126.9918, "category": "관광특구", "code": "11110"},
    {"name": "홍대 관광특구", "lat": 37.5510, "lon": 126.9239, "category": "관광특구", "code": "11440"},

    # --- [3. 고궁/문화유산] ---
    {"name": "경복궁", "lat": 37.5796, "lon": 126.9770, "category": "고궁/문화유산", "code": "11110"},
    {"name": "덕수궁", "lat": 37.5658, "lon": 126.9751, "category": "고궁/문화유산", "code": "11140"},
    {"name": "창경궁·창덕궁", "lat": 37.5794, "lon": 126.9910, "category": "고궁/문화유산", "code": "11110"},
    {"name": "북촌한옥마을", "lat": 37.5829, "lon": 126.9835, "category": "고궁/문화유산", "code": "11110"},
    {"name": "남산골한옥마을", "lat": 37.5591, "lon": 126.9937, "category": "고궁/문화유산", "code": "11140"},

    # --- [4. 공원] ---
    {"name": "뚝섬한강공원", "lat": 37.5284, "lon": 127.0681, "category": "공원", "code": "11215"},
    {"name": "망원한강공원", "lat": 37.5501, "lon": 126.8990, "category": "공원", "code": "11440"},
    {"name": "반포한강공원", "lat": 37.5100, "lon": 126.9960, "category": "공원", "code": "11650"},
    {"name": "여의도한강공원", "lat": 37.5281, "lon": 126.9332, "category": "공원", "code": "11560"},
    {"name": "서울숲공원", "lat": 37.5444, "lon": 127.0374, "category": "공원", "code": "11200"},
    {"name": "어린이대공원", "lat": 37.5480, "lon": 127.0746, "category": "공원", "code": "11215"},

    # --- [발달상권] 28개 거점 (매니저님 요청 목록 반영) ---
    {"name": "가락시장", "lat": 37.4930, "lon": 127.1180, "category": "발달상권", "code": "11710"}, # 송파구
    {"name": "가로수길", "lat": 37.5203, "lon": 127.0230, "category": "발달상권", "code": "11680"}, # 강남구
    {"name": "광장(전통)시장", "lat": 37.5701, "lon": 127.0000, "category": "발달상권", "code": "11110"}, # 종로구
    {"name": "김포공항", "lat": 37.5580, "lon": 126.8020, "category": "발달상권", "code": "11500"}, # 강서구
    {"name": "노량진", "lat": 37.5140, "lon": 126.9420, "category": "발달상권", "code": "11590"}, # 동작구
    {"name": "덕수궁길·정동길", "lat": 37.5660, "lon": 126.9740, "category": "발달상권", "code": "11140"}, # 중구
    {"name": "북촌한옥마을", "lat": 37.5829, "lon": 126.9835, "category": "발달상권", "code": "11110"}, # 종로구
    {"name": "서촌", "lat": 37.5802, "lon": 126.9700, "category": "발달상권", "code": "11110"}, # 종로구
    {"name": "성수카페거리", "lat": 37.5445, "lon": 127.0560, "category": "발달상권", "code": "11200"}, # 성동구
    {"name": "압구정로데오거리", "lat": 37.5268, "lon": 127.0385, "category": "발달상권", "code": "11680"}, # 강남구
    {"name": "여의도", "lat": 37.5216, "lon": 126.9242, "category": "발달상권", "code": "11560"}, # 영등포구
    {"name": "연남동", "lat": 37.5620, "lon": 126.9230, "category": "발달상권", "code": "11440"}, # 마포구
    {"name": "영등포 타임스퀘어", "lat": 37.5170, "lon": 126.9037, "category": "발달상권", "code": "11560"}, # 영등포구
    {"name": "용리단길", "lat": 37.5303, "lon": 126.9702, "category": "발달상권", "code": "11170"}, # 용산구
    {"name": "이태원 앤틱가구거리", "lat": 37.5350, "lon": 126.9940, "category": "발달상권", "code": "11170"}, # 용산구
    {"name": "인사동", "lat": 37.5744, "lon": 126.9880, "category": "발달상권", "code": "11110"}, # 종로구
    {"name": "창동 신경제 중심지", "lat": 37.6531, "lon": 127.0476, "category": "발달상권", "code": "11320"}, # 도봉구
    {"name": "청담동 명품거리", "lat": 37.5260, "lon": 127.0430, "category": "발달상권", "code": "11680"}, # 강남구
    {"name": "청량리 제기동 일대 전통시장", "lat": 37.5800, "lon": 127.0440, "category": "발달상권", "code": "11230"}, # 동대문구
    {"name": "해방촌·경리단길", "lat": 37.5443, "lon": 126.9870, "category": "발달상권", "code": "11170"}, # 용산구
    {"name": "DDP(동대문디자인플라자)", "lat": 37.5665, "lon": 127.0090, "category": "발달상권", "code": "11140"}, # 중구
    {"name": "DMC(디지털미디어시티)", "lat": 37.5770, "lon": 126.8910, "category": "발달상권", "code": "11440"}, # 마포구
    {"name": "북창동 먹자골목", "lat": 37.5620, "lon": 126.9780, "category": "발달상권", "code": "11140"}, # 중구
    {"name": "남대문시장", "lat": 37.5590, "lon": 126.9770, "category": "발달상권", "code": "11140"}, # 중구
    {"name": "익선동", "lat": 37.5740, "lon": 126.9890, "category": "발달상권", "code": "11110"}, # 종로구
    {"name": "잠실롯데타워·석촌호수", "lat": 37.5130, "lon": 127.1030, "category": "발달상권", "code": "11710"}, # 송파구
    {"name": "송리단길·호수단길", "lat": 37.5090, "lon": 127.1100, "category": "발달상권", "code": "11710"}, # 송파구
    {"name": "신촌 스타광장", "lat": 37.5580, "lon": 126.9370, "category": "발달상권", "code": "11410"}  # 서대문구
]
