...
if final_input:
    ...
    with st.chat_message("assistant"):
        with st.spinner("고객이 반응하는 중..."):
            ...
            - (언어 습관) 전문 용어(로컬 필터, 컴프레서 등)는 절대 쓰지 마세요. "물맛이 이상해요", "빨리 시원해지나요?" 처럼 일반인답게 말하세요.
            - (리액션) 매니저의 말이 너무 길거나 장황하면 (약간 지루해하며) "아 네.. 그래서 가격이 얼마죠?" 처럼 반응하세요.
            - (자아 고정) 당신은 LG전자 직원이 아닙니다. 제품 원리를 설명하려 하지 마세요.
            """
