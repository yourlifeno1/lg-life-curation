...
GUIDE_TEXTS = {
    "라포형성": {
        ...
        "desc": "가벼운 스몰토크와 칭찬으로 고객의 긴장을 풀고 대화를 시작하세요!"
    },
    "니즈파악": {
        "title": "🔍 인사이트 스퀘어",
        "slogan": "문장 사이, 숨겨진 진심을 찾으세요.",
        "desc": "예리한 질문으로 고객의 라이프스타일과 숨은 의도를 파악할 시간입니다."
    },
    "클로징": {
        "title": "🏆 골든 피치 아레나",
        "slogan": "승리를 확정 짓는 결정적 한마디.",
        "desc": "확신에 찬 제안으로 고객의 망설임을 없애고 최종 구매를 이끌어내세요."
    },
    "VOC (매장)": {
        "title": "🚨 필드 세이프 존",
        "slogan": "위기를 기회로 바꾸는 현장의 기술.",
        "desc": "불만 고객의 마음을 돌려놓는 유연하고 침착한 대응력을 보여주세요."
    },
    "VOC (전화)": {
        "title": "📞 보이스 컨택트 랩",
        "slogan": "보이지 않는 진심, 목소리의 힘.",
        "desc": "표정이 보이지 않는 만큼 더 세밀한 경청과 공감으로 신뢰를 회복하세요."
    }
}
